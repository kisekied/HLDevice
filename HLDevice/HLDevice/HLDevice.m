...
- (NSDictionary<NSString *, NSNumber *> *)identifierToDeviceModelMap {
    ...
    dispatch_once(&onceToken, ^{
        dict = @{
                 // iPhone
                 @"iPhone1,1": @(HLDeviceModel_iPhone1G),
                 @"iPhone1,2": @(HLDeviceModel_iPhone3G),
                 @"iPhone2,1": @(HLDeviceModel_iPhone3GS),
                 ...
                 // iPod
                 @"iPod1,1": @(HLDeviceModel_iPodTouch1),
                 @"iPod2,1": @(HLDeviceModel_iPodTouch2),
                 @"iPod3,1": @(HLDeviceModel_iPodTouch3),
                 @"iPod4,1": @(HLDeviceModel_iPodTouch4),

...
static inline NSDictionary<NSString *, NSNumber *> *HLDeviceModelMap() {
    return @{
             ...
             @"iPhone14,4": @(HLDeviceModeliPhone13Mini),
             @"iPhone14,5": @(HLDeviceModeliPhone13),
             @"iPhone14,2": @(HLDeviceModeliPhone13Pro),
             @"iPhone14,3": @(HLDeviceModeliPhone13ProMax),
             ...
             @"iPad12,1": @(HLDeviceModeliPad9),
             @"iPad12,2": @(HLDeviceModeliPad9),
             @"iPad13,1": @(HLDeviceModeliPadAir4),
             @"iPad13,2": @(HLDeviceModeliPadAir4),
             @"iPad13,4": @(HLDeviceModeliPadPro11Inch3),
             @"iPad13,5": @(HLDeviceModeliPadPro11Inch3),
             @"iPad13,6": @(HLDeviceModeliPadPro11Inch3),
             @"iPad13,7": @(HLDeviceModeliPadPro11Inch3),
             @"iPad13,8": @(HLDeviceModeliPadPro12Inch5),
             @"iPad13,9": @(HLDeviceModeliPadPro12Inch5),
             @"iPad13,10": @(HLDeviceModeliPadPro12Inch5),
             @"iPad13,11": @(HLDeviceModeliPadPro12Inch5),
             @"iPad14,1": @(HLDeviceModeliPadMini6),
             @"iPad14,2": @(HLDeviceModeliPadMini6),
